...
def calculate_final_coordinates(instructions: List[Instruction],
                                initial_coord: Coordinates,
                                update_coordinates_function: Callable[[Coordinates,
                                                                       Instruction],
                                                                      Coordinates]
                                ) -> Coordinates:
...
if __name__ == "__main__":
    ...
    # Manual check
    instructions_check_data = [('forward', 5),
                               ('down', 5),
                               ('forward', 8),
                               ('up', 3),
                               ('down', 8),
                               ('forward', 2)]
    check_data_coordinates_v1 = calculate_final_coordinates(instructions_check_data, initial_coord_v1, update_coord_v1)
    check_data_coordinates_v2 = calculate_final_coordinates(instructions_check_data, initial_coord_v2, update_coord_v2)
    print(check_data_coordinates_v1[0:2] == (15, 10))
    print(check_data_coordinates_v2[0:2] == (15, 60))

    # Final solution v1
    final_coordinates = calculate_final_coordinates(instructions, initial_coord_v1, update_coord_v1)
    ...
    # Final solution v2
    final_coordinates = calculate_final_coordinates(instructions, initial_coord_v2, update_coord_v2)
    coordinates_multiplier = multiply_coordinates(final_coordinates)
    print("## For full list of instructions, the final coordinates are:", final_coordinates, "and the multiplier is:", coordinates_multiplier)
